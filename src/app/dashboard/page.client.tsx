...
export default function DashboardPageClient({
  ...
  return (
    <main className="container-page space-y-6 tl-dashboard">
          ...
          <div className="flex flex-wrap items-start justify-end gap-2">
            ...
            <span
              className={`inline-flex items-center rounded-full border px-3 py-1 text-sm shadow-sm transition-colors duration-300 ${(isOverPagesLimit || isOverPublishedLimit) && limitPulse
                ? "border-rose-400 bg-rose-500/10 text-rose-600 dark:border-rose-500 dark:bg-rose-900/30 dark:text-rose-300"
      ...
      {isOverPublishedLimit && (
        <div className="rounded-xl border border-rose-500/40 bg-rose-500/10 dark:bg-rose-500/15 p-4 flex items-start gap-3">
          ...
          <div className="flex-1">
            <p className="font-medium text-rose-700 dark:text-rose-300">Published Pages Over Limit</p>
            ...
            <div className="flex gap-3 mt-3">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg text-sm font-medium text-rose-700 dark:text-rose-300 border border-rose-500/50 hover:bg-rose-500/20 transition-colors"
              >
